...
|---|---|---|---|---|---|
| 팀장 | [정수현](https://github.com/WinterFlw) | 프로젝트 총괄 / 파이프라인 통합 담당 | 모델 파이프라인 구현, 실험 구조 개선, 중간 발표, 최종 통합 검수 | `v2/run.sh`, `v2/pipeline/`, `v2/runtime/`, `README.md` | 엔드투엔드 실행 로그, 최종 보고서, 커밋 이력 |
| 팀원 1 | [김정훈](https://github.com/JunghunnKim) | 문제 정의 / 데이터 전처리 담당 | 선행 논문 분석, 문제 정의, 데이터셋 준비, 라벨 매핑, 데이터 분할 검증 | `v2/configs/v2_15seed.json`, `v2/runtime/`, `v2/docs/01_model_definition.md` | 데이터 분할 정책, 전처리 기록, 문제 정의 문서 |
| 팀원 2 | [박종화](https://github.com/jonghwa-8620) | 데이터 분석 / 모델링 담당 | 데이터 분석, EDA, 모델링 보조, 최종 발표 자료 구성 | `v2/runtime/experiment_eda.py`, `v2/runtime/experiment_core.py`, `outputs/` | EDA 산출물, 모델 실험 결과, 발표 자료 |
| 팀원 3 | [조은](https://github.com/silverzzo) | 결과 분석 / 문서 통합 담당 | 데이터 분석, EDA, 실험 결과 해석, 문서 통합 | `v2/outputs/experiments/v2_15seed/benchmark/`, `v2/docs/03_validation_and_statistics.md`, `outputs/` | 성능 요약표, 통계 결과표, 최종 보고서 |
| 팀원 4 | [차종민](https://github.com/JongminCha) | 선행 연구 / 파이프라인 시각화 담당 | 선행 논문 분석, 파이프라인 개선, 파이프라인 시각화, XAI 자료 정리 | `v2/docs/02_e2e_pipeline.md`, `v2/docs/04_xai_protocol.md`, `outputs/` | 파이프라인 문서, XAI 시각화, 발표 자료 |
