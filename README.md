...
| 프로필 | 역할 | 주요 기여 |
|---|---|---|
| <a href="https://github.com/WinterFlw"><img src="https://github.com/WinterFlw.png" width="72" alt="정수현"><br>정수현</a> | 팀장 / 프로젝트 총괄 / 파이프라인 통합 담당 | 모델 파이프라인 구현, 실험 구조 개선, 중간 발표, 최종 통합 검수 |
| <a href="https://github.com/JunghunnKim"><img src="https://github.com/JunghunnKim.png" width="72" alt="김정훈"><br>김정훈</a> | 문제 정의 / 데이터 전처리 담당 | 선행 논문 분석, 문제 정의, 데이터셋 준비, 라벨 매핑, 데이터 분할 검증 |
| <a href="https://github.com/jonghwa-8620"><img src="https://github.com/jonghwa-8620.png" width="72" alt="박종화"><br>박종화</a> | 데이터 분석 / 모델링 담당 | 데이터 분석, EDA, 모델링 보조, 최종 발표 자료 구성 |
| <a href="https://github.com/silverzzo"><img src="https://github.com/silverzzo.png" width="72" alt="조은"><br>조은</a> | 결과 분석 / 문서 통합 담당 | 데이터 분석, EDA, 실험 결과 해석, 문서 통합 |
| <a href="https://github.com/JongminCha"><img src="https://github.com/JongminCha.png" width="72" alt="차종민"><br>차종민</a> | 선행 연구 / 파이프라인 시각화 담당 | 선행 논문 분석, 파이프라인 개선, 파이프라인 시각화, XAI 자료 정리 |
