...
현재 v2 코드는 실행 계획, manifest, 상태 파일, 통계/XAI/report 산출물 골격을 만드는 단계까지 준비되어 있습니다. 실제 학습 실행 연결의 다음 작업은 `v2/pipeline/runner.py`의 benchmark execute adapter 구현입니다.
...
9. `v2/docs/AI_협업_도구_설치_및_사용_가이드.md`
10. `v2/docs/agent_tasks/README.md`
...
| XAI | SHAP, Integrated Gradients, LIME, attention rollout, case review |
